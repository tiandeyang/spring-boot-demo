...
public class RabbitConfig {
    ...
    public static final String REGISTER_EXCHANGE_NAME1 = "dev.book.register.exchange1";
     ...
     **/
    @Bean
    public DirectExchange registerBookTopicExchange() {
        return new DirectExchange(REGISTER_EXCHANGE_NAME1);
    }
